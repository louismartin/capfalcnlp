...
def is_frequent_word_written_in_capitals(word, rank_threshold=50000, **kwargs):
    return is_written_in_capitals(word) and get_rank(word.lower(), **kwargs) < rank_threshold
...
def is_complex_word(word, rank_threshold=3500):
